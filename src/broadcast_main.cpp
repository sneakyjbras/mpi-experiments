...
int main(int argc, char **argv) {
  ...
  results.push_back(mpi_experiments::benchmark_mpi_bcast_large_array(
      rounds, element_count, MPI_COMM_WORLD));
  results.push_back(mpi_experiments::benchmark_manual_broadcast_large_array(
      rounds, element_count, MPI_COMM_WORLD));
  ...
  if (rank == 0) {
    ...
    std::cout << "- MPI_Bcast is the usual optimized collective "
